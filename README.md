...
모니터는 스펙 CSV의 다나와 등록년월(`registration_month`)을 기준으로 매일 목록을 새로 만듭니다.
수집일 기준 당월 포함 최근 3개월 이내에 등록된 상품만 기록하며, 3개월이 지나면 자동으로 목록에서 빠집니다.
갓 등록된 상품은 스펙 크롤(매일 03:00 KST)을 한 번 거친 뒤 목록에 들어오므로 최대 하루 늦게 나타날 수 있습니다.

그 외 카테고리는 상품코드가 `122000000` 이상이면서 처음 발견된 상품만 기록합니다.
